...
classifier = cv2.CascadeClassifier(r'C:/Desktop/sampritafaceproject/sampritafaceproject/haarcascade_frontalface_default (1).xml')

model = load_model(r"C:/Desktop/sampritafaceproject/sampritafaceproject/fac.h5")

URL = 'http://192.168.158.127:8080/shot.jpg'

def get_pred_label(pred):
    labels = ["adyasha","biswakalyan","samprita patra","soumya","Arpita","unknown"]
    return labels[pred]
